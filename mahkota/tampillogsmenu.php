 ...
 */
    ...
    if($tombol == "tampil"){
        ...
        $sqlsel = "SELECT tl.jumlah,tl.kategori,tu.nama AS 'namauser',tm.nama AS 'namamenu',tm.satuan,DATE(tl.created_at) AS 'tanggallogs' FROM tblogsmenu tl INNER JOIN tbproduk tm ON tl.idmenu=tm.id INNER JOIN tbuser tu ON tl.iduser=tu.iduser WHERE tl.id!='' $syarat";
//        echo $sqlsel;
    ?>
