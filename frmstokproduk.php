                            ...
                            <div class="col-md-12">
                                <form class="cmxform" id="frm" method="get" action="">
                                    ...
                                    <div class="form-group form-element">
                                        ...
                                        <select class="form-control col-md-7 col-xs-12 combobox selectpicker" data-live-search="true" data-size="5" name="cmbproduk" id="cmbproduk" onchange="loaddata();">
                                            <option value="-"> -- Pilih Produk -- </option>
                                            <?php
                                                $sqlbahan = "SELECT * FROM tbproduk ORDER BY nama ASC";
