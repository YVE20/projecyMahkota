...
<head>
    ...
    <link rel="shortcut icon" href="asset/img/edelweislogo.jpg">
...
<body id="mimin" class="dashboard form-signin-wrapper">
    <div class="container">
        ...
        <form id="frmlogin" name="frmlogin" method="POST" enctype="multipart/form-data" autocomplete="off" class="form-signin">
            <div class="text-center">
                <img src="asset/img/<?php echo $icon ?>" alt="logo" height="100">
            </div>
            ...
            <div class="panel periodic-login" style="margin-top:50px;">
                ...
                <div class="panel-body text-center">
                    ...
                    <button type="submit" id="btnlogin" name="btnlogin" class="btn col-md-12 btn-round btn-default" value="Sign In"><span class="glyphicon glyphicon-log-in" style="margin-right:5px;"></span> Sign
                        In</button>
                </div>
            </div>
        </form>
