 ...
 */
    ...
    if($tombol == "tampilcari") {
        ...
        // }
        $sqlsel = "SELECT tj.id,tj.tanggal,tjd.jlhpajak,tm.nama as 'namamenu', tj.created_at FROM tbjual tj left join tbjualdetil tjd on tj.id=tjd.idjual left join tbproduk tm on tjd.idmenu=tm.id where tj.id!='' $syarat order by tj.created_at asc";
//        echo $sqlsel;
