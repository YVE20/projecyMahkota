        ...
        while ($re4 = mysqli_fetch_array($query4)) {
            $isi .= '
                <tr>
                    ...
                    <td>
                        Rp. <input type="text" id="harga"  value="' . number_format($re4['subTotal'] / $re4['jumlahBarang'], 0, ',', '.') . '" style="width:70%;text-align: center;border:none;" readonly> 
                    </td>
                    <td> 
                        Rp. <input type="text" id="subTotal" value="' . number_format($re4['subTotal'], 0, ',', '.') . '" style="width:70%;text-align: center;border:none;" readonly> 
                    </td>
                    <td>
