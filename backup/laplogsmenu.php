...
<script>
    ...
    function f_search() {
        ...
        $.post("tampillogsmenu.php", {tombol: "tampil", menu:idproduk,kategori:kategori,tanggalmulai:tanggalmulai,tanggalselesai:tanggalselesai,user:user})
            .done(function (data) {
                $("#table").html(data);
            });
    }
