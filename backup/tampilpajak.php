 ...
 */
    ...
    if($tombol == "tampilcari") {
        ...
        // }
        $sqlsel = "SELECT tj.id,tj.tanggal,tjd.jlhpajak,tm.nama as 'namaproduk', tj.created_at FROM tbjual tj left join tbjualdetil tjd on tj.id=tjd.idjual left join tbproduk tm on tjd.idproduk=tm.id where tj.id!='' $syarat order by tj.created_at asc";
//        echo $sqlsel;
