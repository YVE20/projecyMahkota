<?php
    ...
    if($tombol == "simpan"){
        $sql = "INSERT INTO tblogsmenu (idproduk,jumlah,kategori,iduser) VALUES ('$menu','$jumlah','$kategori','$iduser')";
        $query =  mysqli_query($con,$sql) or die ($sql);

        $sqlbahan = "SELECT jumlah FROM tbproduk WHERE id='$menu'";
        ...
        $sqlupdate = "UPDATE tbproduk set jumlah='$jlhmenu' WHERE id='$menu'";
    ...
    ?>
        <table id="datatable-fixed-header" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
          <?php
            $sqlsel = "SELECT * FROM tbproduk WHERE id='$menu'";
