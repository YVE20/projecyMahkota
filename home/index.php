         ...
         <div class="row">
            ...
            ?>
               <div class="col-md-3 mt-5">
                  <div class="box_text">
                     <div onclick="beliSekarang('<?= $re['kode_barang'] ?>')" style="cursor:pointer;height:15rem">
                        <?php
                        $url_gambar = $re['img_url'];
                        if ($url_gambar == "") { ?>
            ...
            <div class="modal-body">
               <div class="row">
                  ...
                  <div class="col-lg-12 col-12 mt-3">
                     <input type="email" pattern="[^ @]*@[^ @]*" name="email" required id="email" class="form-control" placeholder="Masukkan Email">
                  </div>
                  <div class="col-lg-12 col-12 mt-3">
